...
class Task():
    ...
    def __init__(self, assistant_name):
        self.task_list = [assistant_name, "open my presentation", "next", "previous", "temperature", "time", "date", 'thank you', "open new", "minimize", "close", "new word file", "open", "focus", "maximize", "mode", "finish", "about", "maps", 'weather', 'shopping', 'add', 'directory', "tab", "new powerpoint file"]
    ...
    # return the only the temperature of a city
    ...
    # deschise o specie de nou word, dar nu e ce caut
    ...
    def new_powerpoint_file(self):
        os.system("start powerpnt /B")

    
    # open any file of the computer ---------------------
    ...
    # ----- focus a window what is in the task bar -----------
    ...
    # open maps for a specific place ----------------------
    ...
    # say how is the weather in a specific place ------------------
